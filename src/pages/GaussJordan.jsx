...
export default function GaussJordan() {
  ...
  const { problems, removingIds, refresh, saveProblem, deleteProblem } = useProblems(GaussJordanService);
  ...
  const handleSaveProblem = async () => {
    try {
      ...
      console.log("GaussJordan: saving problem (serialized)", payload);
  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      <PageHeader title="Gauss–Jordan Elimination" subtitle="วิธีการกำจัดแบบเกาส์–จอร์แดน (Reduced Row-Echelon Form)" />
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-slate-800 rounded-lg p-4 shadow fade-in-delay2">
          ...
          <div className="text-sm text-gray-400">
            ใส่เมทริกซ์ A และเวกเตอร์ b แล้วกด "คำนวณ" โปรแกรมจะทำการกำจัดแบบเกาส์–จอร์แดน 
            (ทำให้ได้เมทริกซ์ Reduced Row-Echelon Form) จากนั้นผลลัพธ์ของตัวแปร x₁, x₂, ..., xₙ 
            จะปรากฏในคอลัมน์สุดท้ายของเมทริกซ์
          </div>
