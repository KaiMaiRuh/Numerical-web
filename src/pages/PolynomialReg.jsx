...
export default function PolynomialReg() {
  ...
  // สร้างเมทริกซ์ normal equations สำหรับ Polynomial Regression
  const solvePolynomialRegression = (x, y, m) => {
    const n = x.length;
    ...
    for (let i = 0; i <= m; i++) {
      ...
      if (Math.abs(pivot) < 1e-12)
        throw new Error("Pivot เป็นศูนย์ — ไม่สามารถแก้สมการได้");
